...
<!DOCTYPE html>
<head>
<title>Poojas Resort::CheckIn Guest</title>
...
<body class="dashboard-page">
							...
							<div class="panel panel-widget agile-validation register-form">
								<div class="validation-grids widget-shadow"
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" action="AddCustomer"
											...
											<div class="form-group">
												<div class="radio">
													<label> <input type="radio" id="gender"
														name="gender" required="" value="F"> Female
													</label>
												</div>
												<div class="radio">
													<label> <input type="radio" id="gender"
														name="gender" required="" value="M"> Male
													</label>
												</div>
											</div>
											<div class="form-group">
											...
											<form data-toggle="validator" action="#" method="post">
												...
												<div class="form-group">
													<input type="text" class="form-control" id="adults"
														name="adults" placeholder="No. of Adults" required="">
												</div>
												<div class="form-group">
													<input type="text" class="form-control" id="kids"
	...
	<!-- footer -->
	<div class="footer">
		<p>© 2018 Poojas Resorts . All Rights Reserved</p>
	</div>
	<!-- //footer -->
	<!-- input-forms -->
